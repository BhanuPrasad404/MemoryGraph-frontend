...
export default function DashboardPage() {
    ...
    const getStatusBadge = (status: DocumentStatus) => {
        ...
        return (
            <Badge
                className={`${variant.bg} ${variant.text} ${variant.darkBg} ${variant.darkText} gap-1 text-xs sm:text-sm`}
    ...
    if (error) {
        ...
        return (
            <div className="text-center py-12 sm:py-16 text-red-600 px-4">
    ...
    return (
        <div className="container  mx-auto p-3 sm:p-4 md:p-6 space-y-6 sm:space-y-8 max-w-full">
                ...
                <CardHeader className="px-3 sm:px-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                        <div className="min-w-0">
                            <CardTitle className="text-lg sm:text-xl">Recent Documents</CardTitle>
                ...
                <CardContent className="px-3 sm:px-6">
                    {documents.length === 0 ? (
                        <div className="text-center py-6 sm:py-8 md:py-12">
                            <BrainCircuit className="mx-auto h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-muted-foreground mb-3 sm:mb-4" aria-hidden="true" />
                            <h3 className="text-base sm:text-lg font-medium mb-1 sm:mb-2">No documents yet</h3>
                            <p className="text-muted-foreground mb-4 sm:mb-6 max-w-md mx-auto text-xs sm:text-sm md:text-base px-4">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            {documents.slice(0, 5).map((doc: Document) => (
                                <div
                                    key={doc.id}
                                    className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 rounded-lg border hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
                                >
                                    <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-0">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <div className="flex flex-col xs:flex-row xs:items-center gap-2 sm:gap-3 mb-2">
                                                <p className="font-medium text-sm sm:text-base truncate" title={doc.filename}>
                                                    {doc.filename}
                                                </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                ...
                <Card className="border-l-4 border-blue-500 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
                    <CardHeader className="px-3 sm:px-6">
                        <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
                            <div className="p-1.5 rounded-lg bg-blue-100">
                                <Search className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
                            </div>
                            <span className="text-gray-800">Search Documents</span>
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="px-3 sm:px-6">
                        ...
                        <Link href="/documents">
                            <Button
                                variant="outline"
                                className="w-full text-xs sm:text-sm h-8 sm:h-10 border-blue-200 text-blue-700 hover:bg-blue-50 hover:border-blue-300 transition-colors"
                            >
                ...
                <Card className="border-l-4 border-blue-500 hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
                    <CardHeader className="px-3 sm:px-6">
                        <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
                            ...
                            <span className="text-gray-800">Chat with AI</span>
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="px-3 sm:px-6">
                        <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 line-clamp-2">
                        ...
                        <Link href="/chat">
                            <Button
                                variant="outline"
                                className="w-full text-xs sm:text-sm h-8 sm:h-10 border-blue-200 text-purple-700 hover:bg-purple-50 hover:border-purple-300 transition-colors"
                            >
                    ...
                    <CardHeader className="px-3 sm:px-6">
                        <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
                            <div className="p-1.5 rounded-lg bg-pink-100">
                                <Network className="h-4 w-4 sm:h-5 sm:w-5 text-pink-600" />
                            </div>
                            <span className="text-gray-800">View Graph</span>
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="px-3 sm:px-6">
                        <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 line-clamp-2">
                        ...
                        <Link href="/graph">
                            <Button
                                variant="outline"
                                className="w-full text-xs sm:text-sm h-8 sm:h-10 border-blue-200 text-pink-700 hover:bg-pink-50 hover:border-pink-300 transition-colors"
                            >
